...
<div id="app">
    ...
    <div style="position:relative;" class="p-3 bg-white <?php echo e(request()->is('privacy')?'d-none':''); ?> <?php echo e(request()->is('copyright')?'d-none':''); ?>">
        <img src="<?php echo e(asset('img/shape-min.png')); ?>" alt="" style="position: absolute;top:-120px;right:0px;">
  ...
  <footer class="p-2 text-center bg-dark">
    <div class="row pt-3">
      <div class="col-md-6">
          <img src="<?php echo e(asset('img/logo.png')); ?>" style="width:25%" alt="">
      </div>
      <div class="col-md-6">
        <ul id="footerList">
...
</html><?php /**PATH C:\Users\khencel\Desktop\MyProject\yijing\resources\views/layouts/master.blade.php ENDPATH**/ ?>