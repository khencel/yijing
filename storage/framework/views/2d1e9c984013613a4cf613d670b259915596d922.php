<?php if(auth()->guard()->guest()): ?>
    <nav class="navbar navbar-expand-lg navbar-light w-100" style="position: absolute !important;z-index: 1">
        <a class="navbar-brand" href="/"><img id="mobileLogo" src="<?php echo e(asset('img/logo.png')); ?>" alt="" srcset="" style="width:200px;"></a>
        ...
        <ul class="navbar-nav ml-auto ">
            ...
            <li class="nav-item">
                <a href="<?php echo e(url('/')); ?>" class="nav-link text-white nav-Font" style="cursor: pointer">About Us</a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(url('privacy')); ?>" class="nav-link text-white nav-Font" style="cursor: pointer">Data Privacy</a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(url('copyright')); ?>" class="nav-link text-white nav-Font" style="cursor: pointer">Copyright Notice</a>
            </li>
            <li class="nav-item">
...
<nav class="navbar navbar-expand-md navbar-light" style="background-image: linear-gradient(rgb(255, 38, 0), rgb(255, 255, 255));">
    <div class="container">
        <a class="navbar-brand" href="<?php echo e(url('/home')); ?>">
            <?php if(Auth::user()->is_subscriber == 1): ?>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <?php if(Auth::user()->is_subscriber != null): ?>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          <a class="dropdown-item" href="<?php echo e(url('/oracle/number')); ?>">Numbers</a>
                          <a class="dropdown-item" href="<?php echo e(url('/oracle/text')); ?>">Letters</a>
                        </div>
                    </li>
                <?php else: ?>
                <li class="nav-item">
...
<?php endif; ?>
<?php /**PATH C:\Users\khencel\Desktop\MyProject\yijing\resources\views/partial/navigation.blade.php ENDPATH**/ ?>